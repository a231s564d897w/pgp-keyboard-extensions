...
**PGP Keyboard Extensions** (based on upstream [Gboard-patches v3.11.0](https://github.com/jasonwu1994/Gboard-patches/releases/tag/v3.11.0)).

This is an independent packaging. User-facing name is **PGP**.
