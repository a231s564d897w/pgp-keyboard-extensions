    ...
    public void register(Object controller, Context context) {
        try {
            ...
            active.builderIconResourceMethod.invoke(builder,
                    dev.jason.gboardpatches.extension.accesspoint.AccessPointIcons.pass(safeContext));
    ...
    private static final class OpenAction implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                // Real Pass app in freeform window above keyboard + full-app bubble.
                if (!ProtonPassWindowedLauncher.openWindowedAboveKeyboard(context)) {
                    // Not installed: optional helper panel
