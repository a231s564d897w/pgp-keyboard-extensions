...
final class GboardKeyboardStyleSlotEditorDialog {
    ...
    private static final class Controller {
        ...
        private void selectSlot(int index) {
            ...
            testInput.setText("");
            testResult.setText("");
            commitManuallyEdited = !safeTrim(slot.displayText).equals(safeTrim(slot.commitText));
        ...
        private LinearLayout buildPropertySheet() {
            ...
            sheet.addView(buildLabel(strings.editorDisplayLabel));
            displayInput = buildInput(strings.editorDisplayHint, "");
            sheet.addView(displayInput);

            sheet.addView(buildLabel(strings.editorCommitLabel));
            commitInput = buildInput(strings.editorCommitHint, "");
            sheet.addView(commitInput);
