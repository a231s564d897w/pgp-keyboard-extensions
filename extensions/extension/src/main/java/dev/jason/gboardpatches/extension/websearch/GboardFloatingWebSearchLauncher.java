...
public final class GboardFloatingWebSearchLauncher {
    ...
    public static boolean open(Context context,
        ...
        try {
            ...
            // Prefer in-IME floating WebView panel over launching a browser app.
            try {
                String page = settings.getStartPageUrl();
                if (dev.jason.gboardpatches.extension.websearch.GboardWebSearchOverlayHost
                        .show(launchContext, page != null ? page : "https://www.google.com/")) {
                    return true;
                }
            } catch (Throwable ignoredOverlay) {
            }
