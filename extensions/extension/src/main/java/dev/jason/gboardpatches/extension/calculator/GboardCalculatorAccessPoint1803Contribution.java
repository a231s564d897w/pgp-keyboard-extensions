            ...
            try {
                try {
                    ...
                    GboardCalculatorOverlayHost.setInputConnection(ic);
                                ...
                                // Primary: real Unitto UI inside Gboard (official PWA / product).
                try {
                ...
                // Secondary: installed Unitto app at Floating Web Search height + deep link.
                if (dev.jason.gboardpatches.extension.unitto.UnittoIntegration
                        .openCalculator(context)) {
                    return;
                }
                // Tertiary: built-in engine keypad
